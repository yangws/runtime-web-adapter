...
gulp.task("web-huawei.zip", () => {
    ...
    return gulp.src(packagePaths)
        .pipe(require('gulp-zip')(`web-huawei-${commitInfo.shortHash}.zip`))
        .pipe(gulp.dest("./dist/"))
        .on("end", function() {
            fs.copyFileSync(`./dist/web-huawei-${commitInfo.shortHash}.zip`, "./dist/web-huawei-latest-version.zip", fs.constants.COPYFILE_FICLONE);
