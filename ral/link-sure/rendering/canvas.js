...
let _wuji_getFeature = wuji.getFeature;
let _wuji_setFeature = wuji.setFeature;
...
_FEATURE.registerFeatureProperty(
    ...
    function () { // get method
        if (typeof _wuji_getFeature === "function") {
            let value = _wuji_getFeature(_FEATURE.CANVAS_CONTEXT2D_TEXTBASELINE_ALPHABETIC.name);
            switch (value) {
                case 1:
...
_FEATURE.registerFeatureProperty(
    ...
    function () { // get method
        if (typeof _wuji_getFeature === "function") {
            let value = _wuji_getFeature(_FEATURE.CANVAS_CONTEXT2D_TEXTBASELINE_DEFAULT.name);
            switch (value) {
                case 1:
    ...
    function (value) { // set method
        if (typeof _wuji_setFeature === "function") {
            ...
            return _wuji_setFeature(_FEATURE.CANVAS_CONTEXT2D_TEXTBASELINE_DEFAULT.name, value);
        }
        return false;
    }
);